...
useEffect(()=> {
    axios.get(`http://localhost:8000/api/simulation/posts`)
                  ...
                  <Grid item className={classes.img}>
                    <ButtonBase className={classes.image}>
                      <img
                        ...
                        alt="complex"
                        src="https://cdn2.unrealengine.com/egs-amongus-innersloth-s1-2560x1440-675403774.jpg"
                      />
                    </ButtonBase>
                  </Grid>
